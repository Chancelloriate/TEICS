class EnvironmentsController < ApplicationController
  ...
  private
    ...
    def environment_params
      params.require(:environment).permit(:EnvironmentId, :EnvironmentName, :EnvironmentDescription, :CreatedBy, :CreatedDate, :LastModifiedBy, :LastModifiedDate, :IsDeleted)
    end
end
