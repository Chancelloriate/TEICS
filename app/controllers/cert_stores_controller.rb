class CertStoresController < ApplicationController
  ...
  private
    ...
    def cert_store_params
      params.require(:cert_store).permit(:CertStoreId, :SourceId, :EnvironmentId, :IdentityTypeId, :CertStoreName, :CertStoreDescription, :CertStorePassword, :CertStoreExpirationDate, :UNC, :MimeType, :CreatedBy, :CreatedDate, :LastModifiedBy, :LastModifiedDate, :IsDeleted)
    end
end
