class TeicsAuditLogsController < ApplicationController
  ...
  private
    ...
    def teics_audit_log_params
      params.require(:teics_audit_log).permit(:AuditLogId, :RecordId, :TableName, :Attribute, :PreviousValue, :CurrentValue, :CreatedBy, :CreatedDate, :LastModifiedBy, :LastModifiedDate, :IsDeleted)
    end
end
