class UserStoresController < ApplicationController
  ...
  private
    ...
    def user_store_params
      params.require(:user_store).permit(:UserStoreId, :SourceId, :EnvironmentId, :IdentityTypeId, :UserStoreName, :UserStorePassword, :UserStoreExpirationDate, :CreatedBy, :CreatedDate, :LastModifiedBy, :LastModifiedDate, :IsDeleted)
    end
end
