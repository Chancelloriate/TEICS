class NetworkUsersController < ApplicationController
  ...
  private
    ...
    def network_user_params
      params.require(:network_user).permit(:NetworkUserId, :NetworkFirstName, :NetworkLastName, :Email, :NetworkUserName, :NetworkPassword, :CreatedBy, :CreatedDate, :LastModifiedBy, :LastModifiedDate, :IsDeleted)
    end
end
