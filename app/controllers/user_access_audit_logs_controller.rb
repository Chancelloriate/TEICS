class UserAccessAuditLogsController < ApplicationController
  ...
  private
    ...
    def user_access_audit_log_params
      params.require(:user_access_audit_log).permit(:AuditLogId, :RecordId, :TableName, :Attribute, :PreviousValue, :CurrentValue, :CreatedBy, :CreatedDate, :LastModifiedBy, :LastModifiedDate, :IsDeleted)
    end
end
