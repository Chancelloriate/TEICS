class IdentityTypesController < ApplicationController
  ...
  private
    ...
    def identity_type_params
      params.require(:identity_type).permit(:IdentityTypeId, :IdentityTypeName, :IdentityTypeDescription, :CreatedBy, :CreatedDate, :LastModifiedBy, :LastModifiedDate, :IsDeleted)
    end
end
