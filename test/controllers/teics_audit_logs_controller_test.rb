...
class TeicsAuditLogsControllerTest < ActionController::TestCase
  ...
  test "should create teics_audit_log" do
    assert_difference('TeicsAuditLog.count') do
      post :create, teics_audit_log: { Attribute: @teics_audit_log.Attribute, AuditLogId: @teics_audit_log.AuditLogId, CreatedBy: @teics_audit_log.CreatedBy, CreatedDate: @teics_audit_log.CreatedDate, CurrentValue: @teics_audit_log.CurrentValue, IsDeleted: @teics_audit_log.IsDeleted, LastModifiedBy: @teics_audit_log.LastModifiedBy, LastModifiedDate: @teics_audit_log.LastModifiedDate, PreviousValue: @teics_audit_log.PreviousValue, RecordId: @teics_audit_log.RecordId, TableName: @teics_audit_log.TableName }
    end
  ...
  test "should update teics_audit_log" do
    patch :update, id: @teics_audit_log, teics_audit_log: { Attribute: @teics_audit_log.Attribute, AuditLogId: @teics_audit_log.AuditLogId, CreatedBy: @teics_audit_log.CreatedBy, CreatedDate: @teics_audit_log.CreatedDate, CurrentValue: @teics_audit_log.CurrentValue, IsDeleted: @teics_audit_log.IsDeleted, LastModifiedBy: @teics_audit_log.LastModifiedBy, LastModifiedDate: @teics_audit_log.LastModifiedDate, PreviousValue: @teics_audit_log.PreviousValue, RecordId: @teics_audit_log.RecordId, TableName: @teics_audit_log.TableName }
    assert_redirected_to teics_audit_log_path(assigns(:teics_audit_log))
  end
