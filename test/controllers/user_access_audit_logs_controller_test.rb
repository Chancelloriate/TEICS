...
class UserAccessAuditLogsControllerTest < ActionController::TestCase
  ...
  test "should create user_access_audit_log" do
    assert_difference('UserAccessAuditLog.count') do
      post :create, user_access_audit_log: { Attribute: @user_access_audit_log.Attribute, AuditLogId: @user_access_audit_log.AuditLogId, CreatedBy: @user_access_audit_log.CreatedBy, CreatedDate: @user_access_audit_log.CreatedDate, CurrentValue: @user_access_audit_log.CurrentValue, IsDeleted: @user_access_audit_log.IsDeleted, LastModifiedBy: @user_access_audit_log.LastModifiedBy, LastModifiedDate: @user_access_audit_log.LastModifiedDate, PreviousValue: @user_access_audit_log.PreviousValue, RecordId: @user_access_audit_log.RecordId, TableName: @user_access_audit_log.TableName }
    end
  ...
  test "should update user_access_audit_log" do
    patch :update, id: @user_access_audit_log, user_access_audit_log: { Attribute: @user_access_audit_log.Attribute, AuditLogId: @user_access_audit_log.AuditLogId, CreatedBy: @user_access_audit_log.CreatedBy, CreatedDate: @user_access_audit_log.CreatedDate, CurrentValue: @user_access_audit_log.CurrentValue, IsDeleted: @user_access_audit_log.IsDeleted, LastModifiedBy: @user_access_audit_log.LastModifiedBy, LastModifiedDate: @user_access_audit_log.LastModifiedDate, PreviousValue: @user_access_audit_log.PreviousValue, RecordId: @user_access_audit_log.RecordId, TableName: @user_access_audit_log.TableName }
    assert_redirected_to user_access_audit_log_path(assigns(:user_access_audit_log))
  end
