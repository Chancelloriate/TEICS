...
class CertStoreRolesControllerTest < ActionController::TestCase
  ...
  test "should create cert_store_role" do
    assert_difference('CertStoreRole.count') do
      post :create, cert_store_role: { CertStoreId: @cert_store_role.CertStoreId, CertStoreRoleId: @cert_store_role.CertStoreRoleId, CreatedBy: @cert_store_role.CreatedBy, CreatedDate: @cert_store_role.CreatedDate, IsDeleted: @cert_store_role.IsDeleted, LastModifiedBy: @cert_store_role.LastModifiedBy, LastModifiedDate: @cert_store_role.LastModifiedDate, RoleId: @cert_store_role.RoleId }
    end
  ...
  test "should update cert_store_role" do
    patch :update, id: @cert_store_role, cert_store_role: { CertStoreId: @cert_store_role.CertStoreId, CertStoreRoleId: @cert_store_role.CertStoreRoleId, CreatedBy: @cert_store_role.CreatedBy, CreatedDate: @cert_store_role.CreatedDate, IsDeleted: @cert_store_role.IsDeleted, LastModifiedBy: @cert_store_role.LastModifiedBy, LastModifiedDate: @cert_store_role.LastModifiedDate, RoleId: @cert_store_role.RoleId }
    assert_redirected_to cert_store_role_path(assigns(:cert_store_role))
  end
