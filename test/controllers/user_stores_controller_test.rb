...
class UserStoresControllerTest < ActionController::TestCase
  ...
  test "should create user_store" do
    assert_difference('UserStore.count') do
      post :create, user_store: { CreatedBy: @user_store.CreatedBy, CreatedDate: @user_store.CreatedDate, EnvironmentId: @user_store.EnvironmentId, IdentityTypeId: @user_store.IdentityTypeId, IsDeleted: @user_store.IsDeleted, LastModifiedBy: @user_store.LastModifiedBy, LastModifiedDate: @user_store.LastModifiedDate, SourceId: @user_store.SourceId, UserStoreExpirationDate: @user_store.UserStoreExpirationDate, UserStoreId: @user_store.UserStoreId, UserStoreName: @user_store.UserStoreName, UserStorePassword: @user_store.UserStorePassword }
    end
